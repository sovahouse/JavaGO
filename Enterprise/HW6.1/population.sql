INSERT INTO public.employee (id, surname, name, birth_date, phone, position, salary, photo) VALUES (1, 'Anderson', 'Alex', '1993-07-02', null, 'WAITER', 5000, '/resources/img/employees/1.jpg');
INSERT INTO public.employee (id, surname, name, birth_date, phone, position, salary, photo) VALUES (2, 'Polson', 'Robert', '1992-02-16', null, 'WAITER', 6500, '/resources/img/employees/2.jpg');
INSERT INTO public.employee (id, surname, name, birth_date, phone, position, salary, photo) VALUES (3, 'Debian', 'James', '1986-10-23', null, 'COOK', 10000, '/resources/img/employees/3.png');
INSERT INTO public.employee (id, surname, name, birth_date, phone, position, salary, photo) VALUES (4, 'Anderson', 'Jill', '1993-06-02', null, 'WAITER', 5000, '/resources/img/employees/4.jpeg');
...
INSERT INTO public.menu (name, id) VALUES ('Salads', 2);

INSERT INTO public.menu_list (dish_id, menu) VALUES (1, 'Salads');
